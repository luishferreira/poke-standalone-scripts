...
O Hunt Recommender é somente leitura. Ao abrir ou atualizar o painel, ele lê o Pokémon equipado, o nível, o clã e os eventos ativos da conta e calcula as hunts acessíveis de Kanto e Outland. A lista mostra o melhor ataque, golpes por Pokémon, KOs/h, XP/h e se a hunt é letal. O Tipo do Dia é aplicado ao XP/h das hunts correspondentes; VIP e outros multiplicadores de XP da conta não são incluídos. Ditto, TMs, Orre e Nightmare ficam fora da primeira versão.
